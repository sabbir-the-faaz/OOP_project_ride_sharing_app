...
# Now we need to do the ride matching
class Ride_matching:
    def __init__(self, drivers) -> None:
        self.available_drivers = drivers  # Here we are having the list of available drivers

    def find_driver(self, ride_request):
        if len(self.available_drivers) > 0:
            # TODO: find the closest driver of the ride
...
sakib = Rider("Sakib Khan", 'sakib@gmail.com', 1254, 'Mohakhali', 1200)
niye_jao.add_rider(sakib)
kala_pakhi = Driver('Kala Pakhi', 'kala@sad.cm', 5648, 'Gulshan 1')
